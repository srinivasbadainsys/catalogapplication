...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIONSHIFT_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOCATIONSHIFT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCATIONSHIFT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCATIONSHIFT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIONSHIFT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCATIONSHIFT actions', async () => {
      const expectedActions = [
        {
