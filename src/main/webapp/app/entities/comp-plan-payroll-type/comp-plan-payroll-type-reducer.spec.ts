...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './comp-plan-payroll-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPPLANPAYROLLTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPPLANPAYROLLTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPPLANPAYROLLTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPPLANPAYROLLTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPPLANPAYROLLTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPPLANPAYROLLTYPE actions', async () => {
      const expectedActions = [
        {
