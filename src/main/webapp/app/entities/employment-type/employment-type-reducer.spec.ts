...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYMENTTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYMENTTYPE actions', async () => {
      const expectedActions = [
        {
