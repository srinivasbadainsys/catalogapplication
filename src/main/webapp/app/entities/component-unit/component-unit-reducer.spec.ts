...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPONENTUNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPONENTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPONENTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPONENTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPONENTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPONENTUNIT actions', async () => {
      const expectedActions = [
        {
