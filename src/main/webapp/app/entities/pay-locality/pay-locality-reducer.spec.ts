...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYLOCALITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYLOCALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYLOCALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYLOCALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYLOCALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYLOCALITY actions', async () => {
      const expectedActions = [
        {
