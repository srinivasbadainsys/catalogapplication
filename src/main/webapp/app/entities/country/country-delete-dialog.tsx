...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="catalogapplicationApp.country.delete.question">
        <Translate contentKey="catalogapplicationApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
