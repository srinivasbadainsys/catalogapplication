...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './grade.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GRADE actions', async () => {
      const expectedActions = [
        {
