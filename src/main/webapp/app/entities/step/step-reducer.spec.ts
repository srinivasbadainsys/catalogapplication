...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './step.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STEP_LIST actions', async () => {
    ...
    it('dispatches FETCH_STEP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STEP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STEP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STEP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STEP actions', async () => {
      const expectedActions = [
        {
