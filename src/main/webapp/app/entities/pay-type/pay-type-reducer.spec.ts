...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pay-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYTYPE actions', async () => {
      const expectedActions = [
        {
