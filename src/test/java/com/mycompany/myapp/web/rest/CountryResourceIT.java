...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).code(DEFAULT_CODE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).code(UPDATED_CODE);
        return country;
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).code(UPDATED_CODE);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).code(UPDATED_CODE);
